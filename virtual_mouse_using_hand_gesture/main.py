...
def detect_gesture(frame, landmark_list, processed):
    if len(landmark_list) >= 21:
        ...
        elif is_scroll_up(landmark_list, thumb_index_dist):  # Scroll condition
            pyautogui.scroll(50)  # Scroll up
            cv2.putText(frame, "Scroll Up", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)
        elif is_scroll_down(landmark_list,thumb_index_dist):  # Example condition for scrolling down
